...
10. USAR Command Chain:
  ...
  → Field 依角色回報狀態/ASR/危害/資源/醫療後送/RCM/SITREP
  → WiFiMessage{usar_squad_status | usar_asr_observation | usar_hazard_report | usar_resource_request | usar_medical_update | usar_marking_update | usar_operational_log}
