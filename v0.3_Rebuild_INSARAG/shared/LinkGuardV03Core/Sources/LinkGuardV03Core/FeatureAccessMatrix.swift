...
public enum LinkGuardFeatureAccessMatrix {
    ...
    private static let matrix: [LinkGuardFeature: RoleFeatureAccess] = [
        ...
        .globalMapOverview: .init(.primary, .limited, .limited, .none, .limited, .none),
        .sectorCreation: .init(.limited, .primary, .primary, .none, .none, .none),
        .subSectorCreation: .init(.none, .primary, .primary, .none, .none, .none),
        ...
        .worksiteMarkerSystem: .init(.none, .primary, .primary, .limited, .limited, .none),
        ...
        .medicalEvacuation: .init(.primary, .limited, .none, .none, .primary, .none),
        .hospitalCapacityView: .init(.primary, .limited, .none, .none, .primary, .none),
        ...
        .speechTranscription: .init(.primary, .primary, .primary, .limited, .limited, .none),
        .voiceReport: .init(.primary, .primary, .primary, .primary, .limited, .primary),
        ...
        .aiDecisionAnalysis: .init(.primary, .limited, .limited, .none, .none, .none),
        ...
        .commandAuthoritySwitch: .init(.primary, .limited, .none, .none, .none, .none),
        .eventLog: .init(.primary, .primary, .limited, .none, .limited, .none),
        .disasterStatistics: .init(.primary, .limited, .limited, .none, .limited, .none),
