...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 人員總覽 | ● | ● | ● | ✕ | ○ | ✕ | 人員清單與狀態總覽 |
| GPS定位 | ● | ● | ● | ● | ● | ○ | VO 僅上傳自身位置，不可查看他人；其他角色依權限進行定位與同步 |
...
| 資源管理 | ● | ● | ○ | ✕ | ○ | ✕ | 裝備、人力、資源 |
| PWS整合 | ● | ● | ○ | ✕ | ✕ | ✕ | 公共警報系統整合 |
| EMIC整合 | ● | ✕ | ✕ | ✕ | ✕ | ✕ | UCC-only 外部 EMIC adapter 與政府協同入口 |
| 跨機關通報 | ● | ○ | ✕ | ✕ | ✕ | ✕ | UCC 主責，SCC 可收受或回覆 |
| CEOC任務派遣 | ● | ○ | ✕ | ✕ | ✕ | ✕ | 跨機關任務派遣，不等同現場 FieldTask |
| 應變中心開設層級 | ● | ✕ | ✕ | ✕ | ✕ | ✕ | 一/二/三級開設等級紀錄，UCC 管理 |
| 醫療作業摘要 | ● | ○ | ○ | ✕ | ● | ✕ | 不含生命徵象與 clinical detail 的醫療摘要 |
