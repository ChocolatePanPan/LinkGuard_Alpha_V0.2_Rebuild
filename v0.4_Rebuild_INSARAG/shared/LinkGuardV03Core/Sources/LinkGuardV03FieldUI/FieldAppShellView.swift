...
public struct FieldAppShellView: View {
    private let startupIdentityOptions: [FieldLaunchIdentityOption]
    private let identityPickerTitle: String
    ...
    private var identityOptions: [FieldLaunchIdentityOption] {
    ...
    private static func makeController(appID: LinkGuardAppID, platform: AppPlatform, deviceID: LinkGuardID, displayName: String) -> FieldAppController {
        let localCacheStore = FieldAppController.defaultLocalCacheStore(appID: appID, deviceID: deviceID)
        return FieldAppController(appID: appID, platform: platform, deviceID: deviceID, displayName: displayName, localCacheStore: localCacheStore)
    }
    ...
    private var roleAccent: Color {
        Self.roleAccent(for: controller.runtime.device.appID)
    }

    private static func roleAccent(for appID: LinkGuardAppID) -> Color {
        switch appID {
        case .emt, .emtIPad:
...
public struct FieldLaunchIdentityOption: Identifiable, Equatable, Sendable {
    public let appID: LinkGuardAppID
    public let platform: AppPlatform
    public let deviceID: LinkGuardID
    ...
    public static let unifiedIPhoneOptions: [FieldLaunchIdentityOption] = [
        ...
        FieldLaunchIdentityOption(appID: .teamLeader, platform: .iPhone, deviceID: "IOS-TL-02", displayName: "LinkGuard TL / 副分隊長", code: "TL-02", title: "副分隊長", detail: "協助指揮與安全回報"),
        FieldLaunchIdentityOption(appID: .teamMember, platform: .iPhone, deviceID: "IOS-TE-01", displayName: "LinkGuard TE / 搜救員", code: "TE-01", title: "搜救員", detail: "任務執行、GPS、照片與 SOS"),
        FieldLaunchIdentityOption(appID: .emt, platform: .iPhone, deviceID: "IOS-EMT-01", displayName: "LinkGuard EMT / 救護組長", code: "EMT-01", title: "救護組長", detail: "醫療分流與病患後送"),
        FieldLaunchIdentityOption(appID: .emt, platform: .iPhone, deviceID: "IOS-EMT-02", displayName: "LinkGuard EMT / 救護員", code: "EMT-02", title: "救護員", detail: "START、Vitals、病患照片"),
        FieldLaunchIdentityOption(appID: .volunteer, platform: .iPhone, deviceID: "IOS-VO-01", displayName: "LinkGuard VO / 志工", code: "VO-01", title: "志工", detail: "支援任務、照片、災情與 SOS"),
        FieldLaunchIdentityOption(appID: .volunteer, platform: .iPhone, deviceID: "IOS-VO-02", displayName: "LinkGuard VO / 後勤志工", code: "VO-02", title: "後勤志工", detail: "物資支援與位置回報")
    ]

    public static func options(for appID: LinkGuardAppID) -> [FieldLaunchIdentityOption] {
        switch appID {
        case .sccIPad:
            return [
                FieldLaunchIdentityOption(appID: .sccIPad, platform: .iPad, deviceID: "IPAD-SCC-01", displayName: "LinkGuard SCC iPad / 現場指揮", code: "SCC-01", title: "現場指揮", detail: "Sector Command"),
                FieldLaunchIdentityOption(appID: .sccIPad, platform: .iPad, deviceID: "IPAD-SCC-OPS", displayName: "LinkGuard SCC iPad / 作業協調", code: "SCC-OPS", title: "作業協調", detail: "Operations Coordination"),
                FieldLaunchIdentityOption(appID: .sccIPad, platform: .iPad, deviceID: "IPAD-SCC-SAFE", displayName: "LinkGuard SCC iPad / 安全監控", code: "SCC-SAFE", title: "安全監控", detail: "Safety Watch")
            ]
        case .teamLeader, .teamMember:
            return Array(unifiedIPhoneOptions.prefix(3))
        case .teamLeaderIPad:
            return [
                FieldLaunchIdentityOption(appID: .teamLeaderIPad, platform: .iPad, deviceID: "IPAD-TL-01", displayName: "LinkGuard TL iPad / 分隊長", code: "TL-01", title: "分隊長", detail: "Team Leader"),
                FieldLaunchIdentityOption(appID: .teamLeaderIPad, platform: .iPad, deviceID: "IPAD-TL-02", displayName: "LinkGuard TL iPad / 副分隊長", code: "TL-02", title: "副分隊長", detail: "Deputy Team Leader")
            ]
        case .emt, .emtIPad:
            return [
                FieldLaunchIdentityOption(appID: appID, platform: appID == .emtIPad ? .iPad : .iPhone, deviceID: appID == .emtIPad ? "IPAD-EMT-01" : "IOS-EMT-01", displayName: "LinkGuard EMT / 救護組長", code: "EMT-01", title: "救護組長", detail: "Medical Lead"),
                FieldLaunchIdentityOption(appID: appID, platform: appID == .emtIPad ? .iPad : .iPhone, deviceID: appID == .emtIPad ? "IPAD-EMT-02" : "IOS-EMT-02", displayName: "LinkGuard EMT / 救護員", code: "EMT-02", title: "救護員", detail: "Emergency Medical Technician")
            ]
        case .volunteer:
            return Array(unifiedIPhoneOptions.suffix(2))
        case .ucc, .scc:
            return [
                FieldLaunchIdentityOption(appID: appID, platform: .mac, deviceID: "MAC-CMD-01", displayName: "\(appID.rawValue) / 指揮席", code: "CMD-01", title: "指揮席", detail: "Command Console"),
                FieldLaunchIdentityOption(appID: appID, platform: .mac, deviceID: "MAC-OPS-01", displayName: "\(appID.rawValue) / 作業席", code: "OPS-01", title: "作業席", detail: "Operations Console")
            ]
        }
    }

    public static func pickerSubtitle(for appID: LinkGuardAppID) -> String {
        switch appID {
        case .teamLeader, .teamMember:
            return "TL/TE 小隊作業身分"
        case .emt, .emtIPad:
