...
public struct LinkGuardVersionInfo: Codable, Hashable, Sendable {
    ...
    public static let current = LinkGuardVersionInfo(
        schemaVersion: 1,
        product: "LinkGuard",
        version: SemanticVersion(major: 0, minor: 4, patch: 0, prereleaseIdentifiers: ["alpha", "1"]),
        shortVersion: "0.4.0",
        buildNumber: 400001,
        releaseChannel: .alpha,
        gitTag: "v0.4.0-alpha.1",
        series: "v0.4_Rebuild_INSARAG",
        notes: "v0.4 adds a unified iPhone launcher that selects TL, TE, EMT, or VO field identity before loading the role workflow."
    )
}
