...
public enum UCCSCCCapabilityMatrix {
    public static let scopes: [UCCSCCCapabilityScope] = [
        ...
        .init(id: "agencyMessaging", title: "跨機關通報", ucc: .primary, scc: .assisted),
        .init(id: "ceocMissionDispatch", title: "CEOC任務派遣", ucc: .primary, scc: .assisted),
        .init(id: "eocActivationManagement", title: "應變中心開設層級", ucc: .primary, scc: .unavailable),
        .init(id: "medicalOperationalSummary", title: "醫療作業摘要", ucc: .primary, scc: .assisted),
    ...
    private static let featureScopeMap: [LinkGuardFeature: (ucc: CapabilityScopeSymbol, scc: CapabilityScopeSymbol)] = [
        ...
        .agencyMessaging: (.primary, .assisted),
        .ceocMissionDispatch: (.primary, .assisted),
        .eocActivationManagement: (.primary, .unavailable),
        .medicalOperationalSummary: (.primary, .assisted),
