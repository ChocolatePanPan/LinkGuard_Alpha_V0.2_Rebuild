...
/// Milky Way iPad 急診醫院資料（185 家）
struct MWHospital: Identifiable, Hashable {
...
enum MWHospitalDirectory {
    static let all: [MWHospital] = [
    ...
    static func grouped() -> [(region: MWHospital.Region, items: [MWHospital])] {
        MWHospital.Region.allCases.compactMap { r in
